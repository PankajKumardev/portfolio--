    ...
    <div ref={containerRef} className="min-h-screen">
      ...
      <section id="home" className="relative">
        <div className="mx-auto max-w-6xl px-4 py-24 md:py-32">
          ...
          <div className="mt-10 flex items-center gap-4 text-sm">
            <a href="https://linkedin.com/in/pankajkumardev0" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 underline underline-offset-4 hover:opacity-80">
            ...
            <a href="https://github.com/pankajkumardev" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 underline underline-offset-4 hover:opacity-80">
            ...
            <a href="https://twitter.com/pankajkumar_dev" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 underline underline-offset-4 hover:opacity-80">
            ...
            <a href="https://drive.google.com/file/d/1XdD0LcOhZQl9KJJsL0ewcXonZRP_jQ8b/view" className="inline-flex items-center gap-2 underline underline-offset-4 hover:opacity-80">
            ...
            <a href="mailto:pankajams1234@gmail.com" className="inline-flex items-center gap-2 underline underline-offset-4 hover:opacity-80">
        ...
        <div className="mt-6 grid gap-4">
          <div className="rounded-2xl border border-slate-200 dark:border-white/10 p-4 md:p-6 bg-white dark:bg-transparent">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="font-medium">Full Stack Developer Intern @ Dukaan (Rollout)</div>
              <div className="text-sm text-muted dark:text-white/70">Bangalore (Onsite) | July 2025 - Present</div>
            </div>
            <ul className="mt-4 space-y-2 text-sm md:text-[15px] text-hero dark:text-white">
              <li>Built an AI platform that generates websites from prompts with real-time code streaming and live preview.</li>
              <li>Integrated Monaco Editor with versioning, file explorer, and one-click restore.</li>
              <li>Implemented custom parsing to handle LLM output for accurate single-model generation.</li>
              <li>Added JWT auth, protected routes, OAuth (Google, Twitter), and Nginx to serve static builds.</li>
            </ul>
          </div>
        </div>
      </motion.section>
          ...
          {[
            {
              title: "FlowPay",
              desc:
                "A simulated wallet for P2P transfers and balance additions with a simulated bank.",
              stack:
                "TailwindCSS · Next.js · PostgreSQL · Prisma · NextAuth · Turborepo · Docker · AWS EC2 · CI/CD",
              links: { github: "https://github.com/PankajKumardev/flowpay", live: "http://flowpay-one.vercel.app/", demo: "https://drive.google.com/file/d/1C5EYXgttfM7UXPuQ__ytBI0Cm21jrnml/view" },
            },
            {
              title: "Feed-Wall",
              desc:
                "Collect feedback via an embeddable widget, analyze, and export with AI summaries.",
              stack:
                "TailwindCSS · Next.js · Gemini API · TypeScript · PostgreSQL · Prisma · NextAuth · Docker",
              links: { github: "https://github.com/PankajKumardev/feedwall", live: "https://feedwall.vercel.app/", demo: "https://drive.google.com/file/d/1-I8RIAP4__Cu2Yxz-rTAwNUP7Y1T3AtU/view" },
            },
            {
              title: "Bolt",
              desc:
                "Generate websites from prompts (web-based).",
              stack:
                "TailwindCSS · React.js · Express.js · Gemini API · TypeScript · StackBlitz WebContainer",
              links: { github: "https://github.com/PankajKumardev/Bolt-Clone", live: "https://boltweb-ai.vercel.app/", demo: "https://drive.google.com/file/d/1DB32mZbR76GnCJx8DMzym_df7i33UX7s/view?usp=sharing" },
            },
            {
              title: "Ui-Unify",
              desc:
                "Integrates multiple UI libraries with AI-powered developer tools.",
              stack:
                "TailwindCSS · Next.js · TypeScript · Gemini API · Framer Motion",
              links: { github: "https://github.com/pankajKumardev/ui-unify", live: "https://ui-unify.vercel.app/", demo: "https://drive.google.com/file/d/1klxRjHmezRuy9FRvQsxLL6U80oS8cd-g/view" },
            },
          ].map((p) => (
      ...
      >
        ...
        <div className="mt-6 flex flex-wrap gap-3 text-sm">
          <a className="rounded-full border px-5 py-2 border-slate-400 text-hero bg-white shadow-sm hover:bg-slate-50 hover:shadow-md dark:border-white/20 dark:bg-transparent dark:hover:bg-white/10" href="https://twitter.com/pankajkumar_dev" target="_blank" rel="noreferrer">Twitter</a>
          <a className="rounded-full border px-5 py-2 border-slate-400 text-hero bg-white shadow-sm hover:bg-slate-50 hover:shadow-md dark:border-white/20 dark:bg-transparent dark:hover:bg-white/10" href="https://linkedin.com/in/pankajkumardev0" target="_blank" rel="noreferrer">LinkedIn</a>
          <a className="rounded-full border px-5 py-2 border-slate-400 text-hero bg-white shadow-sm hover:bg-slate-50 hover:shadow-md dark:border-white/20 dark:bg-transparent dark:hover:bg-white/10" href="mailto:pankajams1234@gmail.com">Email</a>
        </div>
      </motion.section>

      <footer className="mx-auto max-w-6xl px-4 py-10 text-xs text-slate-600 dark:text-white/60">
